...
## Accessibility
Chinese (thanks to **TWBOY**), English, French, German (thanks to **ByteBender64**), Portuguese (thanks to **kanadeyoru**), Russian (thanks to **theRealDuda**), Spanish (thanks to **ElGremioMaestro**), Turkish (thanks to **BURAKMESE**) and Vietnamese (thanks to **Blazemc2k5**) translations are included in the base mod, and contributions are welcome. To contribute, see the dedicated [GitHub issue](https://github.com/StardewModders/mod-translations/issues/61).
